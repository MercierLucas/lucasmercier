...
<div class="container">
    <div class="center">
        ...
        <div class="icons">
            ...
            <div><a href="https://www.linkedin.com/in/lucas-mercier-899470171/" target="_blank"><img src={linkedin} alt="" class="icon"></a></div>
            <div><a href="/contact" ><img src={plane} alt="" class="icon"></a></div>
        </div>
    </div>
    <div>
